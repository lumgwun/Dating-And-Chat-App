...
public class AttachmentPreviewAdapter extends BaseAdapter {
    ...
    public Map<File, QBAttachment> fileQBAttachmentMap;
    public Map<File, Integer> fileUploadProgressMap;

    public AttachmentCountChangedListener countChangedListener;
    public AttachmentUploadErrorListener errorListener;
