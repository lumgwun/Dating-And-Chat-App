...
import com.lahoriagency.cikolive.Classes.BaseListAdapter;
import com.lahoriagency.cikolive.Classes.ChatHelper;
import com.lahoriagency.cikolive.Classes.MaskedImageView;
import com.lahoriagency.cikolive.Classes.ResourceUtils;
import com.lahoriagency.cikolive.Classes.TimeUtils;
...
public class ChatAdapter33 extends BaseListAdapter<QBChatMessage> implements StickyListHeadersAdapter {
    ...
    public ChatAdapter33(Context context, QBChatDialog chatDialog, List<QBChatMessage> chatMessages) {
    ...
    private void setMessageBody(final ViewHolder holder, QBChatMessage chatMessage) {
        if (hasAttachments(chatMessage)) {
            ...
            Glide.with(context)
                    ...
                    .load(holder.attachmentImageView)
