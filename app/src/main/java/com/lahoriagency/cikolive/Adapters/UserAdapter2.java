...
public class UserAdapter2 extends BaseAdapter {
    ...
    public UserAdapter2(Context context, List<QBUser> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.list_item_user22, parent, false);
            holder = new ViewHolder();
            holder.rootLayout = convertView.findViewById(R.id.item_root_chat);
            holder.userImageView = convertView.findViewById(R.id.chat_user);
            holder.loginTextView = convertView.findViewById(R.id.chat_user_login);
            holder.userCheckBox = convertView.findViewById(R.id.chat_checkbox);
            holder.userAvatarTitle = convertView.findViewById(R.id.chat_title);
