...
import static com.lahoriagency.cikolive.Classes.DiamondTransfer.DH_DIALOG_ID;
...
import static com.lahoriagency.cikolive.Classes.DiamondTransfer.DH_TO;
...
public class DiamondHisDAO extends DBHelperDAO{
    ...
    @SuppressLint("Range")
    public ArrayList<DiamondTransfer> getDiamondHisTo(int savedProfID){
        SQLiteDatabase db = this.getWritableDatabase();
        ArrayList<DiamondTransfer> dataList = new ArrayList<DiamondTransfer>();
        String selection = DH_TO + "=?";
        String[] selectionArgs = new String[]{valueOf(savedProfID)};
        String[] columns = new String[]{DH_ID,DH_FROM,DH_COUNT,DH_SAVED_PROF_ID,DH_DATE};
    ...
    @SuppressLint("Range")
    public ArrayList<DiamondTransfer> getDiamondHisByDialogID(String savedDialogID){
        SQLiteDatabase db = this.getWritableDatabase();
        ArrayList<DiamondTransfer> dataList = new ArrayList<DiamondTransfer>();
        String selection = DH_DIALOG_ID + "=?";
        String[] selectionArgs = new String[]{savedDialogID};
        String[] columns = new String[]{DH_ID,DH_FROM,DH_COUNT,DH_SAVED_PROF_ID,DH_DATE};
