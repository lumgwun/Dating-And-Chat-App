...
import com.lahoriagency.cikolive.Classes.QBPushSubscribeListenerImpl;
...
import com.lahoriagency.cikolive.Interfaces.FcmConsts;
                ...
                case REQUEST_SELECT_PEOPLE:
                    ...
                    if (isPrivateDialogExist(selectedUsers)) {
                        ...
                        if (existingPrivateDialog != null) {
                            ChatAct.startForResult(this, REQUEST_DIALOG_ID_FOR_UPDATE, existingPrivateDialog);
                        }
                    } else {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (currentActionMode != null) {
                    ...
                    ChatHelper.getInstance().loginToChat(currentUser, new QBEntityCallback<Void>() {
                        ...
                        public void onSuccess(Void aVoid, Bundle bundle) {
                            hideProgressDialog();
                            ChatAct.startForResult(DialogsActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, selectedDialog);
                        }
        ...
        ChatHelper.getInstance().createDialogWithSelectedUsers(selectedUsers, chatName,
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog dialog, Bundle args) {
                        ...
                        ChatAct.startForResult(DialogsActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, dialog, true);
                        hideProgressDialog();
                    }
    ...
    private void initConnectionListener() {
        ...
        chatConnectionListener = new VerboseQbChatConnectionListener(rootView) {
            ...
            public void reconnectionFailed(Exception error) {
                ...
                showErrorSnackbar(R.string.reconnect_failed, (QBResponseException) error, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        reloginToChat();
                    }
