...
public class MessageInfoAct extends BaseActivity implements QBMessageStatusListener {
    private static final String TAG = MessageInfoAct.class.getSimpleName();
    ...
    public static void start(Context context, QBChatMessage chatMessage, String messageInfoType) {
        Intent intent = new Intent(context, MessageInfoAct.class);
    ...
    private void fillAdapter(ArrayList<QBUser> qbUsers) {
        usersListView.setAdapter(new UserAdapter2(this, qbUsers));
