...
public class CallServiceNew extends Service {
    private static final String TAG = CallServiceNew.class.getSimpleName();
    ...
    public static void start(Context context, QBUser qbUser, PendingIntent pendingIntent) {
        Intent intent = new Intent(context, CallServiceNew.class);
            ...
            chatService.login(qbUser, new QBEntityCallback<QBUser>() {
                ...
                public void onError(QBResponseException e) {
                    ...
                    try {
                        ...
                        Toast.makeText(CallServiceNew.this, "Check Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }catch (Exception e){
    ...
    private void initQBRTCClient() {
        ...
        SettingsUtil.configRTCTimers(CallServiceNew.this);
    ...
    private void sendResultToActivity(boolean isSuccess, String errorMessage) {
        if (pendingIntent != null) {
            ...
            try {
                ...
                pendingIntent.send(CallServiceNew.this, Consts.EXTRA_LOGIN_RESULT_CODE, intent);
