...
public class ConFChatAdapter extends RecyclerView.Adapter<ConFChatAdapter.NewMessageViewHolder> implements
        StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    private static final String TAG = ConFChatAdapter.class.getSimpleName();
    ...
    private final HashMap<String, Integer> fileLoadingAttemptsMap = new HashMap<>();

    private final SparseIntArray containerLayoutRes = new SparseIntArray() {
        {

            put(TYPE_TEXT_RIGHT, R.layout.list_item_mes_right);
            put(TYPE_TEXT_LEFT, R.layout.list_item_mes_left);
            put(TYPE_ATTACH_RIGHT, R.layout.list_item_mes_right);
            put(TYPE_ATTACH_LEFT, R.layout.list_item_mes_left);
            put(TYPE_NOTIFICATION_CENTER, R.layout.list_item_notification_message);
            put(TYPE_NOTIFICATION_CONFERENCE_RIGHT, R.layout.list_item_mes_right);
            put(TYPE_NOTIFICATION_CONFERENCE_LEFT, R.layout.list_item_mes_left);
            put(CUSTOM_VIEW_TYPE, R.layout.list_item_notification_message);
        }
    };

    public ConFChatAdapter(Context context, QBChatDialog chatDialog, List<QBChatMessage> chatMessages) {
    ...
    private void fillTextMessageHolder(NewMessageViewHolder holder, QBChatMessage chatMessage, boolean isIncomingMessage) {
        ...
        String forwardedFromName = (String) chatMessage.getProperty(ConfChatAct.PROPERTY_FORWARD_USER_NAME);
    ...
    private void fillAvatarHolder(NewMessageViewHolder holder, QBChatMessage chatMessage) {
        ...
        holder.avatar.setBackground(UiUtilsCon.getColorCircleDrawable(context, chatMessage.getSenderId().hashCode()));
    ...
    public int getItemViewType(int position) {
        ...
        if (chatMessage != null) {
            if (chatMessage.getProperty(DialogsManager.PROPERTY_NOTIFICATION_TYPE) != null) {
                ...
                boolean conference = notificationType.equals(DialogsManagerCon.START_CONFERENCE);
                boolean stream = notificationType.equals(DialogsManagerCon.START_STREAM);
    ...
    class NewMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvFileSize = itemView.findViewById(R.id.tv_attach_file_sizeCon);
        TextView tvFileName = itemView.findViewById(R.id.tv_attach_file_nameCon);
        TextView llFileForwardedFromUser = itemView.findViewById(R.id.tv_file_forward_from_user);
        LinearLayout llFileForwardContainer = itemView.findViewById(R.id.ll_file_forw_cont);

        LinearLayout rootLayout = itemView.findViewById(R.id.ll_root_me_item);
        LinearLayout llMessageContainer = itemView.findViewById(R.id.ll_me_container);
        TextView tvUserName = itemView.findViewById(R.id.tv_con_user_name);
        ImageView ivMessageStatus = itemView.findViewById(R.id.iv_con_mes_status);
        TextView tvMessageTime = itemView.findViewById(R.id.tv_con_time_sent);
        LinearLayout llMessageBodyContainer = itemView.findViewById(R.id.ll_message_body_con);
        LinearLayout llMessageBodyForwardContainer = itemView.findViewById(R.id.ll_forwarded_cont);
        ProgressBar pbFileProgress = itemView.findViewById(R.id.pb_attach_file);
        ...
        TextView tvTextForwardedFromUser = itemView.findViewById(R.id.tv_con_for_from_user);
        TextView tvMessageBody = itemView.findViewById(R.id.tv_con_message_body);
        LinearLayout llConferenceContainer = itemView.findViewById(R.id.ll_conf_container);
        RelativeLayout rlImageAttachmentContainer = itemView.findViewById(R.id.rl_image_attach_con);
        ImageView ivImageAttachPreview = itemView.findViewById(R.id.iv_attach_con_image_preview);
        LinearLayout llImageForwardContainer = itemView.findViewById(R.id.ll_image_forwarded_cont);
        TextView tvImageForwardedFromUser = itemView.findViewById(R.id.tv_image_f_from_user);
        ProgressBar pbImageProgress = itemView.findViewById(R.id.pb_attach_con_image);
        RelativeLayout rlVideoAttachmentContainer = itemView.findViewById(R.id.rl_video_attach_cont);
        ImageView ivVideoAttachPreview = itemView.findViewById(R.id.iv_attach_video_con_preview);
        ProgressBar videoProgress = itemView.findViewById(R.id.pb_attach_con_video);
        LinearLayout llVideoForwardContainer = itemView.findViewById(R.id.ll_video_forw_conta);
        TextView llVideoForwardedFromUser = itemView.findViewById(R.id.tv_video_forw_fr_user);
        TextView tvVideoFileName = itemView.findViewById(R.id.tv_attach_con_video_name);
        TextView tvVideoFileSize = itemView.findViewById(R.id.tv_attach_con_video_size);
        RelativeLayout rlFileAttachmentContainer = itemView.findViewById(R.id.rl_file_atta_conta);
        TextView tvConferenceNotificationBody = itemView.findViewById(R.id.tv_confer_not_body);
    ...
    static class ImageLoadListener<M> implements RequestListener<M> {
        private final NewMessageViewHolder holder;
    ...
    private class FileLoaderAsyncTask extends BaseAsyncTaskCon<Void, Void, Void> {
