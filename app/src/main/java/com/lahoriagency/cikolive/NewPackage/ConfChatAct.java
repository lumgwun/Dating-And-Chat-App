...
import com.lahoriagency.cikolive.Adapters.AttachmentPreviewAdapter;
...
import com.lahoriagency.cikolive.Classes.NetworkConnectionChecker;
...
import com.lahoriagency.cikolive.Conference.AttachmentVideoAct;
import com.lahoriagency.cikolive.Conference.BaseActCon;
import com.lahoriagency.cikolive.Conference.CallActCon;
import com.lahoriagency.cikolive.Conference.ChatInfoAct;
import com.lahoriagency.cikolive.Conference.MediaPickHelperCon;
import com.lahoriagency.cikolive.Conference.OpponentsActivity;
import com.lahoriagency.cikolive.Conference.PermissionsActivity;
import com.lahoriagency.cikolive.Conference.SystemPermissionsHelper;
import com.lahoriagency.cikolive.Conference.WebRtcSessManagerCon;
import com.lahoriagency.cikolive.ForwardToActivity;
...
import com.lahoriagency.cikolive.MessageInfoAct;
...
public class ConfChatAct extends BaseActCon implements OnMediaPickedListener,DialogsManager.ManagingDialogsCallbacks, QBMessageStatusListener,View.OnClickListener {
    ...
    private ConFChatAdapter chatAdapter;
    ...
    private WebRtcSessManagerCon sessionManager;
    ...
    private WebRtcSessManagerCon webRtcSessionManager;
    private ImageView ImgBtnSend,attachmentBtnChat;
    ...
    public static void startForResultFromCall(Activity activity, int code, String dialogId, boolean isOpenFromCall) {
        ...
        intent.putExtra(ConfChatAct.EXTRA_DIALOG_ID, dialogId);
        intent.putExtra(ConfChatAct.EXTRA_IS_OPEN_FROM_CALL, isOpenFromCall);
    ...
    public static void startForResult(Activity activity, int code, String dialogId, boolean isNewDialog) {
        Intent intent = new Intent(activity, ChatMatchAct.class);
        intent.putExtra(ConfChatAct.EXTRA_DIALOG_ID, dialogId);
        intent.putExtra(ConfChatAct.EXTRA_IS_NEW_DIALOG, isNewDialog);
        activity.startActivityForResult(intent, code);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_conf_chat);
        ...
        chipNavigationBar = findViewById(R.id.bottom_chatCon);
        ...
        homeFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(ConfChatAct.this, MainActivity.class);
        ...
        if((QBChatDialog) getIntent().getSerializableExtra(EXTRA_DIALOG_ID) != null) {
            ...
            if (isRunForCall && webRtcSessionManager.getCurrentSession() != null) {
                CallActivity.start(ConfChatAct.this, true);
            }
        }
        ...
        intentBundle.putParcelable("QBUser", (Parcelable) qbUser);
        intentBundle.putParcelable("SavedUser",savedProfile);
        chipNavigationBar.setOnItemSelectedListener
                (new ChipNavigationBar.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(int i) {
                        ...
                        switch (i){
                            case R.id.chatA_HomeCon:
                                Intent myIntent = new Intent(ConfChatAct.this, MainActivity.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                                myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                myIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                myIntent.putExtra(ConfChatAct.EXTRA_DIALOG_ID, qbChatDialog);
                                myIntent.putExtra(ConfChatAct.EXTRA_IS_NEW_DIALOG, dialogID);
                                myIntent.putExtras(intentBundle);
                                startActivity(myIntent);

                            case R.id.con_Chat_menu:

                                Intent chatIntent = new Intent(ConfChatAct.this, ChatInfoAct.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                                chatIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                chatIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                chatIntent.putExtra(ConfChatAct.EXTRA_DIALOG_ID, qbChatDialog);
                                chatIntent.putExtra(ConfChatAct.EXTRA_IS_NEW_DIALOG, dialogID);
                                chatIntent.putExtra(SelectUsersActivity.EXTRA_QB_USERS,SelectUsersActivity.EXTRA_QB_USERS);
                                chatIntent.putExtras(intentBundle);
                                startActivity(chatIntent);


                            case R.id.con_calls:

                                Intent callIntent = new Intent(ConfChatAct.this, CallActCon.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                                callIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                callIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                callIntent.putExtra(ConfChatAct.EXTRA_DIALOG_ID, qbChatDialog);
                                callIntent.putExtra(ConfChatAct.EXTRA_IS_NEW_DIALOG, dialogID);
                                callIntent.putExtras(intentBundle);
                                startActivity(callIntent);

                            case R.id.opponents_con:

                                Intent pIntent = new Intent(ConfChatAct.this, OpponentsActivity.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                                pIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                pIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                pIntent.putExtra(ConfChatAct.EXTRA_DIALOG_ID, qbChatDialog);
                                pIntent.putExtra(ConfChatAct.EXTRA_IS_NEW_DIALOG, dialogID);
                                pIntent.putExtras(intentBundle);
    ...
    private void initViews() {
        ...
        chatMessagesRecyclerView = findViewById(R.id.rv_chat_mesC);

        messageEditText = findViewById(R.id.et_chat_messageCon);
        iv_firsticon = findViewById(R.id.iv_1sticon);
        ImgBtnSend = findViewById(R.id.iv_chat_send);
        txtTypingStatus = findViewById(R.id.tv_typingCon_status);
        ...
        progressBar = findViewById(R.id.progress_chatCon);
        attachmentPreviewContainerLayout = findViewById(R.id.ll_attachment_preview_tainer);

        attachmentBtnChat = findViewById(R.id.iv_chat_achmentCon);
        attachmentBtnChat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (attachmentPreviewAdapter.getCount() >= MAX_ATTACHMENTS_COUNT) {
                    ToastUtilsCon.shortToast(ConfChatAct.this, R.string.error_attachment_count);
                } else {
                    openImagePicker();
                }
            }
...
//        }
        ChatHelper.getInstance().getDialogs(requestBuilder, new QBEntityCallback<ArrayList<QBChatDialog>>() {
            ...
            public void onError(QBResponseException e) {
                setOnRefreshListener.setRefreshing(false);
                Toast.makeText(ConfChatAct.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private String createNewStreamID() {
        ...
        streamID = currentUserID + "_" + timeStamp;
        return streamID;
    }
    ...
    private void startStream(String newStreamID) {
        ...
        client.createSession(currentUser.getId(), conferenceType, new ConferenceEntityCallback<ConferenceSession>() {
            ...
            public void onSuccess(ConferenceSession conferenceSession) {
                ...
                setCallButtonsDefault();
                CallActCon.start(ConfChatAct.this, newStreamID, currentUser.getFullName(), qbChatDialog.getDialogId(), qbChatDialog.getOccupants(), false);
            }
    ...
    private void joinStream(String roomId, String streamerName) {
        ...
        client.createSession(currentUser.getId(), conferenceType, new ConferenceEntityCallback<ConferenceSession>() {
            ...
            public void onSuccess(ConferenceSession session) {
                ...
                sessionManager.setCurrentSession(session);
                Log.d(TAG, "Session Created Successfully. \n Session ID = " + session.getSessionID() + "\n Dialog ID = " + session.getDialogID());
                CallActCon.start(ConfChatAct.this, roomId, streamerName, qbChatDialog.getDialogId(), qbChatDialog.getOccupants(), true);
            }
    ...
    private void showFilePopup(int itemViewType, final QBAttachment attachment, View view) {
        ...
        if (itemViewType == ConFChatAdapter.TYPE_TEXT_RIGHT || itemViewType == ConFChatAdapter.TYPE_ATTACH_RIGHT) {
            popupMenu.setGravity(Gravity.RIGHT);
        } else if (itemViewType == ConFChatAdapter.TYPE_TEXT_LEFT || itemViewType == ConFChatAdapter.TYPE_ATTACH_LEFT) {
            popupMenu.setGravity(Gravity.LEFT);
        }
    ...
    private void startChatInfoWithUpdatedDialog() {
        ...
        QBRestChatService.getChatDialogById(qbChatDialog.getDialogId()).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog updatedChatDialog, Bundle bundle) {
                ...
                getQBDialogsHolder().addDialog(updatedChatDialog);
                hideProgressDialog();
                ChatInfoAct.start(ConfChatAct.this, qbChatDialog.getDialogId());
            }
    ...
    private void openAlertDialogWaitChat() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ConfChatAct.this, R.style.AlertDialogStyle);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == -1) {
            ...
            if(deleteDialog) {
                ...
                dialogsManagerCon.sendSystemMessageAboutDeletingDialog(systemMessagesManager, qbChatDialog);
            ...
            if (requestCode == REQUEST_CODE_SELECT_PEOPLE && data != null) {
                ...
                QBRestChatService.getChatDialogById(qbChatDialog.getDialogId()).performAsync(new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                        ...
                        if (qbChatDialog != null) {
                            ConfChatAct.this.qbChatDialog = qbChatDialog;
                        }
        ...
        QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog result, Bundle params) {
                ...
                if (openDialogFromSwiping){
                    ...
                    ChatAct.startForResult(ConfChatAct.this, REQUEST_DIALOG_ID_FOR_UPDATE, result);
                }
            }
    ...
    protected void onResume() {
        ...
        sessionManager = WebRtcSessManagerCon.getInstance();
    ...
    public void onSendChatClick(View view) {
        ...
        if (!uploadedAttachments.isEmpty()) {
            if (uploadedAttachments.size() == totalAttachmentsCount) {
                ...
                ToastUtilsCon.shortToast(ConfChatAct.this, R.string.chat_wait_for_attachments_to_upload);
            }
        }
    ...
    private void openImagePicker() {
        ...
        if (permissionHelper.isSaveImagePermissionGranted()) {
            MediaPickHelperCon.pickAnImage(this, REQUEST_CODE_ATTACHMENT);
        } else {
    ...
    private void initMessagesRecyclerView() {
        ...
        chatAdapter = new ConFChatAdapter(ConfChatAct.this, qbChatDialog, messagesList);
    ...
    private void sendChatMessage(final String text, final QBAttachment attachment) {
        if (getChatHelper().isLogged()) {
            ...
            if (!QBDialogType.PRIVATE.equals(qbChatDialog.getType()) && !qbChatDialog.isJoined()) {
                ...
                ToastUtilsCon.shortToast(ConfChatAct.this, R.string.chat_still_joining);
                return;
            }
            ...
            try {
                ...
                ToastUtilsCon.shortToast(ConfChatAct.this, R.string.chat_error_send_message);
            }
        } else {
            ...
            getChatHelper().loginToChat(currentUser, new QBEntityCallback<Void>() {
                ...
                public void onError(QBResponseException e) {
                    ...
                    hideProgressDialog();
                    ToastUtilsCon.shortToast(ConfChatAct.this, R.string.chat_send_message_error);
                }
            });
        }
    }
        ...
        if (qbChatDialog != null) {
            switch (qbChatDialog.getType()) {
                ...
                case PRIVATE:
                    ...
                    break;
                default:
                    ToastUtilsCon.shortToast(ConfChatAct.this, String.format("%s %s", getString(R.string.chat_unsupported_type), qbChatDialog.getType().name()));
    ...
    private void setChatNameToActionBar() {
        String chatName = QBDialogUtils.getDialogName(ConfChatAct.this, qbChatDialog);
    ...
    private void deleteChat() {
        if (qbChatDialog.getType() == QBDialogType.PUBLIC_GROUP) {
            ToastUtilsCon.shortToast(ConfChatAct.this, R.string.public_group_chat_cannot_be_deleted);
        } else {
    ...
    private void initChatConnectionListener() {
        ...
        chatConnectionListener = new VerboseQbChatConnectionListener(ConfChatAct.this, rootView) {
            @Override
    ...
    private void startSuitableConversation(QBChatMessage qbChatMessage) {
        String notificationType = (String) qbChatMessage.getProperty(DialogsManagerCon.PROPERTY_NOTIFICATION_TYPE);
        boolean isConference = notificationType.equals(DialogsManagerCon.START_CONFERENCE);
        boolean isStream = notificationType.equals(DialogsManagerCon.START_STREAM);

        if (isConference) {
            checkConferencePermissions();
        } else if (isStream) {
            streamID = (String) qbChatMessage.getProperty(DialogsManagerCon.PROPERTY_CONVERSATION_ID);
    ...
    private class ImageAttachClickListener implements ConFChatAdapter.AttachClickListener {

        @Override
        public void onAttachmentClicked(int itemViewType, View view, QBAttachment attachment) {
            if (attachment != null) {
                String url = QBFile.getPrivateUrlForUID(attachment.getId());
                AttachmentImageActivity.start(ConfChatAct.this, url);
            }
        }
    }

    private class VideoAttachClickListener implements ConFChatAdapter.AttachClickListener {

        @Override
        public void onAttachmentClicked(int itemViewType, View view, QBAttachment attachment) {
            if (attachment != null) {
                String url = QBFile.getPrivateUrlForUID(attachment.getId());
                AttachmentVideoAct.start(ConfChatAct.this, attachment.getName(), url);
            }
        }
    }

    private class FileAttachClickListener implements ConFChatAdapter.AttachClickListener {
    ...
    private class MessageLongClickListenerImpl implements ConFChatAdapter.MessageLongClickListener {
        @Override
    ...
    private class ConversationNotificationClickListenerImpl implements ConFChatAdapter.ConversationNotificationClickListener {
        @Override
    ...
    private class PaginationListener implements ConFChatAdapter.PaginationHistoryListener {
        @Override
    ...
    private class TypingStatusListener implements QBChatDialogTypingListener {
        ...
        public void processUserIsTyping(final String dialogID, final Integer userID) {
            ...
            if (dialogID != null && dialogID.equals(qbChatDialog.getDialogId()) && userID != null && !userID.equals(currentUserID)) {
                ...
                txtTypingStatus.setText(makeStringFromNames());
        ...
        public void processUserStopTyping(String dialogID, Integer userID) {
            ...
            if (dialogID != null && dialogID.equals(qbChatDialog.getDialogId()) && userID != null && !userID.equals(currentUserID)) {
                ...
                if (TextUtils.isEmpty(makeStringFromNames())) {
                    txtTypingStatus.setVisibility(View.GONE);
                }
            }
        }
